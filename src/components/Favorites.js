    ...
    return (
        <>
           {favList === undefined || favList.length === 0 ? <main className="pokedex-container container"><h1 className="heading positioned-heading">You Have No Favorite Pokemon.<br/>Fav 'em All!</h1><div className="cta">
              ...
              <img src={ item.pokemon.sprites.other.dream_world.front_default ? item.pokemon.sprites.other.dream_world.front_default : item.pokemon.sprites.other["official-artwork"].front_default} alt={item.pokemon.name}/>
